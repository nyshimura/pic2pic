    ...
    <script>
        ...
        document.getElementById('form-login').addEventListener('submit', async function(e) {
            ...
            if (etapaLogin === 1) {
                ...
                try {
                    const r = await fetch('processadores/autenticacao/verificar_email_login.php', { method: 'POST', body: formData, credentials: 'same-origin' });
                ...
                try {
                    const r = await fetch('processadores/autenticacao/validar_login.php', { method: 'POST', body: formData, credentials: 'same-origin' });
                    const res = await r.json();
        ...
        document.getElementById('form-cadastro').addEventListener('submit', async function(e) {
            ...
            try {
                const r = await fetch('processadores/autenticacao/cadastrar_fotografo.php', { method: 'POST', body: formData, credentials: 'same-origin' });
                const res = await r.json();
